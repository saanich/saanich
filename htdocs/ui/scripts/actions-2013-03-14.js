...
//Keyboard-friendly site nav
  $('#nav-site ul ul a').focus(function() { $(this).offsetParent("ul").css('top','100%'); }); //bring sub-menu on screen with focus
  $('#nav-site ul ul a').blur(function() { $(this).offsetParent("ul").css('top','-1000px'); }); //put sub-menu off-screen with blur
